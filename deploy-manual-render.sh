...
echo "   sh -c 'echo \"Waiting for database to be ready...\" && cd /app/backend && python wait_for_db.py && echo \"Initializing database...\" && python init_db.py && echo \"Adding users...\" && python add_multiple_users.py && echo \"Running comprehensive verification...\" && python verify_setup.py && echo \"Starting combined application...\" && /app/start.sh'"
echo ""
